<x-app-layout>
                ...
                <div class="flex">
                    <div>
                        ...
                        <select id="sort" name="sort" class="mr-4">
                            ...
                            <option value="{{  \Constant::SORT_ORDER['higherPrice'] }}" @if(\Request::get('sort')===\Constant::SORT_ORDER['higherPrice']) selected @endif>料金高い順
                            </option>
                        ...
                        <div class="w-1/4 p-2 md:p-4">
                            <a href="{{ route('user.items.show', ['item' => $product->id]) }}">
                                <div class="border rounded-md p-4">
                                    ...
                                    <div class="mt-4">
                                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">C{{ $product->category }}</h3>
    ...
    <script>
        //表示順を変更すると同時に画面を更新してその表示順に反映する処理
